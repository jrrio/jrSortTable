...
2. Download [jrSortTable_1.4.js](https://github.com/jrodgs/jrSortTable/blob/master/jrSortTable.js) and place a script tag referring to it just before the closing *body* tag. _E.g._
